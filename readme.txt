...
* Downloading and installing the dsIDXpress plugin is 100% free, but the data from your MLS is not. You can use the free demo data (see here: http://www.dsidxpress.com/tryit/) or see about obtaining your MLS's data here: http://www.dsidxpress.com/
